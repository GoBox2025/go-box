...
function rolcambio() {
    ...
    var anuncio = confirm("esta seguro de cambiar a viajero y empezar a ganar con GoBox?");

    if (anuncio == true) {
        window.location.href = "Home_viajero.html" /*hola helen, aca vas a poner la dirección para la home de viajero*/
...
async function Guardar() {
    ...
    try {
        ...
        botonEdit.textContent = "Editar";
         ...
         if (seleccion == "Viajero") { //Luz debes cambiar aca a "Comprador"
        rolcambio();
     };
